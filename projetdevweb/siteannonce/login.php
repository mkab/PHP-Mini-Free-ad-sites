        ...
        <body>
            ...
            <section>
                <div id="main" class="wrapper">
                    <noscript>
                    <div class="error">
                       <strong>JavaScript</strong> is disabled.
                    </div>    
                    </noscript>
                    <?php
                        ...
                        <form id="myForm" action="verifylogin.php" method="post">
                            <fieldset>
                                ...
                                <p>
                                    ...
                                    <span class="tooltip"><img src="images/tick.jpg" alt="tick" width="15" height="15"> 
                                        &nbsp; Le mot de passe ne doit pas faire moins de 6 caractères</span>
                                </p>
                                <?php
                                if ($_SERVER['HTTP_REFERER']) {
                                    echo '<p><input type="hidden" name="lastpagevisited" value="' . htmlspecialchars($_SERVER['HTTP_REFERER']) . '" /></p>';
                                }
                                ?>
                                <p><input type="hidden" name="login_submitted" value="1" /></p>

                                <p>
                                    <input type="submit" value="Se connecter"/> <input type="reset" value="Réinitialiser le formulaire"/>
                                </p>

                                <p align="center"><a href="/form/forgotten_passwd.php">Vous avez perdu votre mot de passe ?</a></p>
                            </fieldset>
                        </form>
                    </article>
                </div>
